...
public class Chart2 extends javax.swing.JFrame {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				String now = new SimpleDateFormat("dd.MM.yyy hh:mm:ss")
						.format(new Date());
				title_chart2 = "Chart: " + Calculation.chartlist_header2 + "  "
						+ now;
				Chart2 f = new Chart2(title_chart2, X_FRAME, Y_FRAME, X_CHART,
						Y_CHART);
	...
	public static class Diagramm extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			g2.setFont(g2.getFont().deriveFont(3f));
			for (int i = 0; i < xmaxvalue - 1; i++) {
				// g2.drawString(cal.Calculation.chartlist2[0][i+1], i * 7,
				// +10);
	...
	public Chart2(java.lang.String titel2, int x, int y, int w, int h) {
		super(titel2);
		this.setSize(w, h);
