...
public class Calculation implements Runnable {
	...
	static String TEXTARRAY[] = {
			...
			("//Set XML Rootnamespace: xs = <Objects+xs>  http:/www.abc.de > autochange 1 slash into double slash"),
			("//Set XML Namespace: xs = <Object+xs>  http:/www.abc.de > autochange 1 slash into double slash"),
			("//------------------------------------------------------"),
			("//CHECK-COMMANDS:"),
